...
biocLite("rtracklayer");biocLite("GenomicAlignments");library(openssl);library(Rsamtools);library(rtracklayer);library(GenomicAlignments);
...
devtools::install_github("jimhester/covr");devtools::install_github("mskilab/skitools")'
